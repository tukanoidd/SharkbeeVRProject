...
public class OVRPlayerController : MonoBehaviour
{
    ...
    private bool
        SkipMouseRotation = true; // It is rare to want to use mouse movement in VR, so ignore the mouse by default.
    ...
    private bool
        ReadyToSnapTurn; // Set to true when a snap turn has occurred, code requires one frame of centered thumbstick to enable another snap turn.
    ...
    void Update()
    {
        HaltUpdateMovement = lockedMovement;
    ...
    protected virtual void UpdateController()
    {
        ...
        Vector3 predictedXZ =
            Vector3.Scale((Controller.transform.localPosition + moveDirection), new Vector3(1, 0, 1));
